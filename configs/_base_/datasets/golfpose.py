dataset_info = dict(
    ...
    keypoint_info={
        ...
        28:
        dict(name='golf_club_head', id=28, color=[255, 0, 0], type='', swap=''),
        29:
        dict(name='golf_club_tail', id=29, color=[255, 0, 0], type='', swap=''),
    },
    skeleton_info={
        0:
        ...
        24:
        dict(link=('right_ankle', 'right_big_toe'), id=24, color=[255, 128, 0]),
        25:
        dict(link=('right_ankle', 'right_small_toe'), id=25, color=[255, 128, 0]),
        26:
